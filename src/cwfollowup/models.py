...
class CwFollowupJob(models.Model):
    ...
    def __str__(self):
        return f"CwFollowup Job: {self.name}"
...
class Data(models.Model):
    ...
    """
    job = models.OneToOneField(CwFollowupJob, related_name='data', on_delete=models.CASCADE)

    data_choice = models.CharField(
        max_length=55,
        choices=cwfollowup_parameters.DATA_SOURCES,
        default=cwfollowup_parameters.REAL_DATA[0]
    )
...
class DataParameter(models.Model):
    ...
    """
    job = models.ForeignKey(CwFollowupJob, related_name='data_parameter', on_delete=models.CASCADE)
...
class Search(models.Model):
    ...
    Search Container
    """
    job = models.OneToOneField(CwFollowupJob, related_name='search', on_delete=models.CASCADE)
...
class SearchParameter(models.Model):
    ...
    """
    job = models.ForeignKey(CwFollowupJob, related_name='search_parameter', on_delete=models.CASCADE)
